...
def run_model(known_file, known_name, test_files):
    ...
    strt = time.time()
    faces_1, match_1, time_1 = model_1(model, known_files, test_files, verbose)
    print("Model 1 completed in time", time.time() - strt)
    strt = time.time()
    faces_2, match_2, time_2 = model_2(model, known_files, test_files, verbose)
    print("Model 2 completed in time", time.time() - strt)
    strt = time.time()
    faces_3, match_3, time_3 = model_3(model, known_files, test_files, verbose)
